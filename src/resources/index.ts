...
import { AbsenceBalancesResource } from "./absenceBalances.js";
import { AbsenceCalendarResource } from "./absenceCalendar.js";
import { AbsencePoliciesResource } from "./absencePolicies.js";
...
import { EmployeeInvitationsResource } from "./employeeInvitations.js";
import { EmployeeSeatsResource } from "./employeeSeats.js";
...
import { TimeBalancesResource } from "./timeBalances.js";
...
export { AbsenceCalendarResource } from "./absenceCalendar.js";
export { AbsencePoliciesResource } from "./absencePolicies.js";
...
export { EmployeeInvitationsResource } from "./employeeInvitations.js";
export { EmployeeSeatsResource } from "./employeeSeats.js";
...
export { TimeBalancesResource } from "./timeBalances.js";
...
export interface ResourceNamespaces {
  absenceBalances: AbsenceBalancesResource;
  absenceCalendar: AbsenceCalendarResource;
  absencePolicies: AbsencePoliciesResource;
  ...
  employeeInvitations: EmployeeInvitationsResource;
  employeeSeats: EmployeeSeatsResource;
  ...
  taxes: TaxesResource;
  timeBalances: TimeBalancesResource;
...
export function createResources(client: HttpClient): ResourceNamespaces {
  return {
    absenceBalances: new AbsenceBalancesResource(client),
    absenceCalendar: new AbsenceCalendarResource(client),
    absencePolicies: new AbsencePoliciesResource(client),
    ...
    employeeInvitations: new EmployeeInvitationsResource(client),
    employeeSeats: new EmployeeSeatsResource(client),
    ...
    timeBalances: new TimeBalancesResource(client),
